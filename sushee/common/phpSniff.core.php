...
`/sushee/common/phpSniff.core.php` is part of Officity.
...
{   // initialize some vars
    ...
    {   // regexes to use
        ...
        // look for iphone
        elseif( preg_match($regex_iphone,$this->_browser_info['ua']) )
		{   $this->_set_browser('os','iphone');
