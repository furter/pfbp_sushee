...
<xsl:stylesheet version="1.0"
  ...
  <!-- lower and upper contain pairs of lower and upper case
  ...
  <!--doc:template name="to-upper" xmlns="">
  ...
  <!--doc:template name="to-lower" xmlns="">
  ...
  <!--doc:template name="capitalise" xmlns="">
  ...
  <!--doc:template name="to-camelcase" xmlns="">
  ...
  <!--doc:template name="substring-before-first" xmlns="">
  ...
  <!--doc:template name="substring-after-last" xmlns="">
    <refpurpose>String extraction</refpurpose>
  ...
  <!--doc:template name="substring-before-last" xmlns="">
    <refpurpose>String extraction</refpurpose>
  ...
  <!--doc:template name="count-substring" xmlns="">
...
<xsl:call-template name="count-substring">
  ...
  <!--doc:template name="substring-after-at" xmlns="">
    <refpurpose>String extraction</refpurpose>
    <refdescription>
  ...
  <!--doc:template name="substring-before-at" xmlns="">
    <refpurpose>String extraction</refpurpose>
    <refdescription>
      <para>Extracts the portion of a 'char' delimited 'text' string "array" at a given 'position' </para>
    </refdescription>
  ...
  <!--doc:template name="insert-at" xmlns="">
  ...
  <!--doc:template name="backward" xmlns="">
  ...
  <!--doc:template name="justify" xmlns="">
  ...
  <!--doc:template name="character-first" xmlns="">
  ...
  <!--doc:template name="string-match" xmlns="">
...
<xsl:call-template name="string-match">
  ...
  <!--doc:template name="generate-string" xmlns="">
