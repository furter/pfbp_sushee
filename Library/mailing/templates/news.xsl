		...
		<html>
			<head>
				...
				<style>
					...
					#best{width:360px; margin:40px auto 40px; text-align:left;}
					...
					#body h2{margin-bottom:5px; margin-top:20px;}
					#signature {border-top:3px solid yellow; padding-top:5px; width:400px; margin-top:30px; text-align:left; color:#333; font-size:11px;}
					#signature a{color:#333;}
					#signature a:hover{text-decoration:underline;}
					
					#bottom{min-height:22px; margin-top:30px; margin-bottom:30px; background:white url(<xsl:value-of select="//NECTIL/host"/>/common/images/bb_540.gif) no-repeat center bottom;}	
			...
			<body>
				<div id="container">
					...
					<xsl:choose>
						<xsl:when test="$mailing/DESCRIPTIONS/DESCRIPTION/CUSTOM/PoliteFemale != '' and $recipient/INFO/GENDER = 'F'">
							<div id="best">
								<p>
									<xsl:value-of select="$mailing/DESCRIPTIONS/DESCRIPTION/CUSTOM/PoliteFemale"/>
								</p>
							</div>
						</xsl:when>
						<xsl:when test="$mailing/DESCRIPTIONS/DESCRIPTION/CUSTOM/PoliteMale != '' and $recipient/INFO/GENDER = 'M'">
							<div id="best">
								<p>
									<xsl:value-of select="$mailing/DESCRIPTIONS/DESCRIPTION/CUSTOM/PoliteMale"/>
								</p>
							</div>
						</xsl:when>
						<xsl:when test="$mailing/DESCRIPTIONS/DESCRIPTION/CUSTOM/PoliteNeutral">
							<div id="best">
								<p>
									<xsl:value-of select="$mailing/DESCRIPTIONS/DESCRIPTION/CUSTOM/PoliteNeutral"/>
								</p>
							</div>
						</xsl:when>
					</xsl:choose>
