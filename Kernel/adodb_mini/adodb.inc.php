 ...
 */
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
	...
	/**
	* Added By Verdeyen Boris, in order to check if a connection is active or not
	*/
	...
	*/
	...
	{
		return $this->_connected = $this->Connect($argHostname, $argUsername, $argPassword, $argDatabaseName, true);
	}
